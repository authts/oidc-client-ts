...
describe("ClaimsService", () => {
    ...
    describe("mergeClaims", () => {
        ...
        it("should not merge (but append) claims when claim types are objects, if using legacy merge behavior", () => {
            // arrange
            Object.assign(settings, { mergeClaimsLegacyBehavior: true });
        ...
        it("should merge claims when claim types are objects", () => {
            ...
            // assert
            expect(result).toEqual({ custom: { "apple": "foo", "orange": "peel", "pear": "bar" }, b: "banana" });
        });

        it("should merge claims when claim types are objects when mergeClaims settings is true, if using legacy merge behavior", () => {
            // arrange
            Object.assign(settings, { mergeClaims: true, mergeClaimsLegacyBehavior: true });
